...
Enable interactive configuration of the left-hand Vive Tracker attachment point with both positional offset and local rotational correction, allowing users to fine-tune the attach-axis frame in real time.
## Requirements
